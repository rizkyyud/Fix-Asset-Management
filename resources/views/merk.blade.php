            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a class="nav-link" href="merk"><i
                                    class="fab fa-apple"></i>Merk</a></li>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6">
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#merkModal">
        ...
        <tbody>
            ...
            @foreach ($merk as $items)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editMerk{{ $items->id }}"
                            href="#"><i class="fas fa-edit"></i></a>
                        <a class="btn btn-danger" href="/merk/del/{{ $items->id }}"
...
@endsection
{{-- Tambah Merk --}}
<div class="modal fade" id="MerkModal" tabindex="-1" aria-labelledby="kategoriModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="card">
                <form class="needs-validation was-validated" novalidate="" action="merk" method="post">
                    @csrf
                    <div class="card-header card text-center">
                        <h4>Form Input Merk</h4>
                    </div>
                    <div class="card-body">
...
@foreach ($merk as $data)
    <div class="modal fade" id="editMerk{{ $data->id }}" tabindex="-1" aria-labelledby="editKategoriLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="card">
                    <form class="needs-validation was-validated" novalidate=""
                        action="{{ url('/merk/up/' . $data->id) }}" method="post">
                        @csrf
                        <div class="card-header card text-center">
                            <h4>Form Input Merk</h4>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="merk" placeholder="Merk"
                                        required="" value="{{ $data->merk }}">
                                    <div class="invalid-feedback">
                                        Merk Tidak Boleh kosongan
                                    </div>
                                </div>
                            </div>
                        </div>
